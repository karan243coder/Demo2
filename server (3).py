                ...
                for update in data.get("result", []):
                    ...
                    if media:
                        ...
                        if file_size > 20 * 1024 * 1024:
                            srv_url = global_server_url or os.environ.get("SERVER_URL", "https://familiar-gertrudis-botakingtipd-f3991937.koyeb.app").rstrip("/")
                            send_telegram_direct(chat_id, f"⚠️ <b>FILE TOO LARGE FOR BOT CHAT (20 MB Limit)</b>\n━━━━━━━━━━━━━━━━━━\nYour file is <b>{fmt_size(file_size)}</b>. Standard Telegram Bot servers cannot export download links for files over 20 MB.\n\n🚀 <b>TO SHARE LARGE FILES (NO LIMIT!):</b>\nPlease upload directly on your MeetLink Website: <b>{srv_url}</b>\n\nThere is NO size limit on the website! You can upload 250 MB, 500 MB, or 1 GB directly on the website and get instant high-speed View & Download links!")
                            continue
...
<form method="GET"><input type="password" name="pwd" placeholder="Enter 4-digit PIN / Password" required autofocus><button type="submit">Unlock & Download</button></form></div></body></html>''', 401
    ...
    if info.get("telegram_direct"):
        ...
        return jsonify({"error": "Failed to fetch Telegram CDN stream"}), 500
